...
export interface Problem {
  ...
  slug: string;
  title: string;
  topic: 'arrays' | 'strings' | 'linked-list' | 'trees' | 'graphs' | 'dp';
...
export const PROBLEMS: Problem[] = [
  ...
  // LINKED LISTS (5 problems - array serialized for easy browser test evaluation)
  {
    id: 'll-1',
    ...
    statement:
      'Given the head of a singly linked list represented as a sequence of values, reverse the list and return the reversed sequence.',
    examples: [
  ...
  },
  {
    ...
    statement:
      'Given the head of a singly linked list, return the values starting from the middle node to the end. If there are two middle nodes, return from the second middle node.',
    examples: [
    ...
    starterCode: `function solve(headArray) {\n  let slow = 0, fast = 0;\n  while (fast < headArray.length && fast + 1 < headArray.length) {\n    slow += 1;\n    fast += 2;\n  }\n  return headArray.slice(slow);\n}`,
    functionName: 'solve',
    testCases: [
  ...
  },
  {
    ...
    statement:
      'You are given two sorted linked lists list1 and list2. Merge the two lists into one sorted list and return its values.',
    examples: [
  ...
  },
  {
    ...
    statement:
      'Given the head of a linked list, remove the nth node from the end of the list and return the resulting node values.',
    examples: [
    ...
    starterCode: `function solve(head, n) {\n  const indexToRemove = head.length - n;\n  return head.filter((_, idx) => idx !== indexToRemove);\n}`,
    functionName: 'solve',
    testCases: [
  ...
  // TREES (5 problems)
  {
    ...
    statement:
      'Given the level-order array representation of a binary tree, return its maximum depth (number of nodes along the longest path from root to leaf).',
    examples: [
  ...
  },
  {
    ...
    statement:
      'Given the root of a complete binary tree level-order array, invert the tree by swapping every left and right child and return the inverted level-order array.',
    examples: [
    ...
    starterCode: `function solve(arr) {\n  const result = [];\n  let levelSize = 1, i = 0;\n  while (i < arr.length) {\n    const level = arr.slice(i, i + levelSize).reverse();\n    result.push(...level);\n    i += levelSize;\n    levelSize *= 2;\n  }\n  return result;\n}`,
    functionName: 'solve',
    testCases: [
  ...
  },
  {
    ...
    statement:
      'Given the level-order representation of a binary tree, determine if it is a valid Binary Search Tree (BST).',
    examples: [
  ...
  },
  {
    ...
    statement:
      'Given the level-order array of a Binary Search Tree and an integer k (1-indexed), return the kth smallest value in the tree.',
    examples: [
  ...
  },
  {
    ...
    statement:
      'Given the level-order arrays of two binary trees p and q, write a function to check if they are structurally identical and nodes have the same values.',
    examples: [
  ...
  },
  {
    ...
    statement:
      'There is a bi-directional graph with n vertices. Given n, an edge list edges, source, and destination, return true if there is a valid path from source to destination.',
    examples: [
  ...
  },
  {
    ...
    statement:
      'There are numCourses courses labeled 0 to numCourses - 1. Given prerequisites[i] = [ai, bi] meaning you must take bi before ai, return true if you can finish all courses.',
    examples: [
  ...
  },
  {
    ...
    statement:
      'Given an image grid, starting pixel (sr, sc), and a new color, perform a 4-directional flood fill from the starting pixel and return the modified image.',
    examples: [
      {
    ...
    testCases: [
      {
        ...
        label: '3x3 flood fill center'
      },
      {
        input: [[[0, 0, 0], [0, 0, 0]], 0, 0, 0],
        expected: [[0, 0, 0], [0, 0, 0]],
        label: 'Same color no-op'
      },
      {
        input: [[[1, 0], [0, 1]], 0, 0, 5],
        expected: [[5, 0], [0, 1]],
        label: 'Single isolated cell'
      }
    ]
  },
  {
    ...
    statement:
      'In a town of n people labeled 1 to n, the town judge trusts nobody and everybody else trusts the town judge. Return the label of the town judge, or -1 if none exists.',
    examples: [
  ...
  },
  {
    ...
    statement:
      'Given an integer array nums representing the amount of money of each house along a street, return the maximum amount of money you can rob tonight without alerting the police (cannot rob two adjacent houses).',
    examples: [
    ...
    starterCode: `function solve(nums) {\n  let rob1 = 0, rob2 = 0;\n  for (const n of nums) {\n    const nextRob = Math.max(n + rob1, rob2);\n    rob1 = rob2;\n    rob2 = nextRob;\n  }\n  return rob2;\n}`,
    functionName: 'solve',
    testCases: [
  ...
  },
  {
    ...
    statement:
      'You are given an integer array coins representing coins of different denominations and an integer amount. Return the fewest number of coins that you need to make up that amount, or -1 if impossible.',
    examples: [
  ...
  },
  {
    ...
    statement:
      'There is a robot on an m x n grid at top-left (0, 0). The robot can only move down or right. Return the number of possible unique paths to reach the bottom-right corner (m - 1, n - 1).',
    examples: [
