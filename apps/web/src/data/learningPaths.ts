...
export const LEARNING_PATHS: LearningPath[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { type: 'problem', id: 'daily-temperatures', title: 'Daily Temperatures', summary: 'Monotonic decreasing stack of indices: pop when finding a warmer day.', readingLinks: ['https://en.wikipedia.org/wiki/Monotonic_stack'] },
      ...
      { type: 'problem', id: 'longest-common-prefix', title: 'Longest Common Prefix', summary: 'Trie or character-by-character horizontal scan across strings.' },
      ...
      { type: 'problem', id: 'flood-fill', title: 'Flood Fill', summary: 'Grid BFS/DFS: replace connected component with new color.' },
  ...
  },
  {
    ...
    steps: [
      ...
      { type: 'problem', id: 'trapping-rain-water', title: 'Trapping Rain Water', summary: 'Two pointers converge while tracking max left and right walls to accumulate trapped water.', readingLinks: ['https://en.wikipedia.org/wiki/Two-pointer_technique'] },
      ...
      { type: 'problem', id: 'sliding-window-maximum', title: 'Sliding Window Maximum', summary: 'Monotonic decreasing deque keeps candidate maxima at the front over each window shift.', readingLinks: ['https://en.wikipedia.org/wiki/Monotonic_queue'] },
      ...
      { type: 'problem', id: 'largest-rectangle-in-histogram', title: 'Widest Bar Rectangle', summary: 'Monotonic stack finds nearest smaller bars left and right to compute maximal rectangle.', readingLinks: ['https://en.wikipedia.org/wiki/Monotonic_stack'] },
      ...
      { type: 'problem', id: 'longest-common-prefix', title: 'Longest Common Prefix', summary: 'Full trie chain in category order.' },
      { type: 'problem', id: 'merge-intervals', title: 'Merge Intervals', summary: 'Full intervals chain in category order.' },
      { type: 'problem', id: 'roman-to-integer', title: 'Roman to Integer', summary: 'Full math-matrices chain in category order.' },
      { type: 'problem', id: 'spiral-matrix', title: 'Spiral Matrix', summary: 'Full math-matrices chain in category order.' },
      ...
      { type: 'quiz', id: 'mixed', title: 'Mastery mock', summary: 'Full platform-level mock assessment across all topics.' },
    ]
  },
];
